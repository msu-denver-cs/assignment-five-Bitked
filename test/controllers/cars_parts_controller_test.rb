...
class CarsPartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cars_part" do
    assert_difference('CarsPart.count') do
      post cars_parts_url, params: { cars_part: { car_id: @cars_part.car_id, name: @cars_part.name, part_id: @cars_part.part_id } }
    end
  ...
  test "should update cars_part" do
    patch cars_part_url(@cars_part), params: { cars_part: { car_id: @cars_part.car_id, name: @cars_part.name, part_id: @cars_part.part_id } }
